...
public class ClientRepositoryTest {
    ...
    @Test
    @DisplayName("Should return true when name client exist")
    public void returnTrueWhenIsbnExists(){
        Client client = createNewClient();
        em.persist(client);

        boolean exists = repository.existsByNome(CLIENT_NAME);
    ...
    @Test
    @DisplayName("Should return false when name client doesn't exists")
